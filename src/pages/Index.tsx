					...
					<div className="hero-content-grid">
						...
						<div className="hero-portrait-col">
							...
							<div className="hero-gold-circle">
								...
								<img
									src={
										"https://res.cloudinary.com/dxoorukfj/image/upload/v1784550650/ABIMBOLA_-_Dear_Singles_xjcf5h.png"
									}
				...
				<div className="hero-features-bar lg:hidden">
					<div className="hero-features-inner">
						<div className="hero-feature-item">
							<span className="hero-feature-icon text-[#d4930a]">
								<Feather className="w-5 h-5" />
							</span>
							<div>
								<p className="hero-feature-title">Stories</p>
								<p className="hero-feature-sub">that inspire & transform</p>
							</div>
						</div>
						...
						<div className="hero-feature-item">
							...
							<div>
								<p className="hero-feature-title">Reflections</p>
								<p className="hero-feature-sub">on love, life and growth</p>
							</div>
						</div>
						...
						<div className="hero-feature-item">
							...
							<div>
								<p className="hero-feature-title">Community</p>
								<p className="hero-feature-sub">for thoughtful conversations</p>
							</div>
						</div>
					</div>
				</div>
			...
			<section id="about" className="section-padding bg-white">
				<div className="max-w-7xl mx-auto">
					<div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-start">
						{/* Left — Text */}
						<div>
							<span className="reveal section-label mb-6 block">
								About Abimbola
							</span>
							...
							<div className="space-y-5 text-neutral-600 text-[15px] leading-relaxed">
								<p className="reveal">
									My name is Abimbola Lawuyi, and for most of my life, I have
									been the person people come to when they need to think
									something through. About love. About faith. About the choices
									that will shape their next season.
								</p>
								<p className="reveal">
									I am an author, coach, and educational leader with more than
									20 years of experience walking alongside people through their
									most important decisions. I have sat with people at every
									stage, those still waiting, those already committed, and those
									standing at crossroads they never expected. I know those
									conversations. I have been in them myself.
								</p>
								<p className="reveal">
									At the heart of everything I do is one belief: that love
									deserves clarity. That the relationships we commit to should
									be chosen wisely, intentionally, and with a deep knowledge of
									ourselves.
								</p>
							</div>
			...
			<section id="books" className="section-padding bg-neutral-50">
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16">
						<span className="reveal section-label justify-center mb-5 block">
							Books by Abimbola
						</span>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
						...
						<div className="space-y-6 text-left">
							...
							<p className="reveal text-neutral-600 text-[15px] leading-relaxed">
								The Clarity Space is a community for anyone who wants to think
								deeply about love, grow intentionally, and choose wisely whether
								you are single, in a relationship, or simply done living without
								clarity. We gather once a month to talk, reflect, and do the
								quiet, important work of knowing ourselves.
							</p>
						...
						<div className="reveal">
							<div className="bg-neutral-50 rounded-2xl p-6 md:p-8 shadow-sm border border-neutral-100 max-w-xl mx-auto lg:max-w-none text-left">
				...
				<div className="max-w-7xl mx-auto">
					<div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
						...
						<div>
							...
							<div className="space-y-5 text-neutral-600 text-[15px] leading-relaxed">
								<p className="reveal">
									Twice a month, I send something real. A reflection. A letter.
									A thought I have been sitting with. The kind of thing you read
									slowly, over tea, when you want to think about your life on
									purpose.
								</p>
								...
								{!formSubmitted ? (
									<>
										...
										<p className="text-neutral-400 text-xs italic mt-5 text-center">
											Bi-monthly. Thoughtful. You can unsubscribe anytime, but I
											hope you stay.
										</p>
									</>
								) : (
