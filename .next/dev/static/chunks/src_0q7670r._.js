...
const Preloader = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Preloader.useEffect": ()=>{
            ...
            let isMounted = true;
            const preloadImages = {
                "Preloader.useEffect.preloadImages": async ()=>{
                    // 1. Create promises for all images
                    const imagePromises = IMAGES_TO_PRELOAD.map({
                        "Preloader.useEffect.preloadImages.imagePromises": (src)=>{
                            return new Promise({
                                "Preloader.useEffect.preloadImages.imagePromises": (resolve)=>{
                                    const img = new Image();
                                    img.src = src;
                            ...
                            }["Preloader.useEffect.preloadImages.imagePromises"]);
                        }
                    }["Preloader.useEffect.preloadImages.imagePromises"]);
                    // 2. We want to show the loader for at least 800ms so it doesn't flash abruptly,
                    // but if the network is really slow, we fallback at 2 seconds to avoid a blank screen.
                    const minDelay = new Promise({
                        "Preloader.useEffect.preloadImages": (resolve)=>setTimeout(resolve, 800)
                    }["Preloader.useEffect.preloadImages"]);
                    const maxDelay = new Promise({
                        "Preloader.useEffect.preloadImages": (resolve)=>setTimeout(resolve, 2000)
                    }["Preloader.useEffect.preloadImages"]);
                    ...
                    if (isMounted) {
                        ...
                        setTimeout({
                            "Preloader.useEffect.preloadImages": ()=>setVisible(false)
                        }["Preloader.useEffect.preloadImages"], 800);
                    }
                }
            }["Preloader.useEffect.preloadImages"];
            preloadImages();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: `fixed inset-0 z-[100] flex flex-col items-center justify-center bg-white transition-opacity duration-700 ease-in-out ${loading ? "opacity-100" : "opacity-0 pointer-events-none"}`,
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "w-2 h-2 rounded-full bg-[#c9963f] animate-bounce",
                            style: {
                                animationDelay: "0ms"
                            }
                        }, void 0, false, {
...
_s(Preloader, "jwMIXHFGWiehNrH7wQK21nywTuM=");
_c = Preloader;
...
//# sourceMappingURL=src_0q7670r._.js.map